...
import com.metron.xiaoming.databinding.FragmentProfitTypeChannelBinding;
 ...
 * 收益BTC:渠道专员
 */
public class ProfitTypeChannelFragment extends BaseBindFragment<FragmentProfitTypeChannelBinding> {
    private String type;

    public ProfitTypeChannelFragment(String type) {
        this.type = type;
    }

    @Override
    public int initLayoutResId() {
        return R.layout.fragment_profit_type_channel;
    }
    ...
    public void requestData() {
        ApiUtil.apiService().incomeLatest(2, type, new Callback<IncomeLastest>() {
            @Override
        ...
        ApiUtil.apiService().withdrawStats(2, type, new Callback<WithdrawStats>() {
            @Override
        ...
        ApiUtil.apiService().incomeList(2, type, new Callback<IncomeList>() {
            @Override
